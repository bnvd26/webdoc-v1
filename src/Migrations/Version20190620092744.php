 ...
 */
final class Version20190620092744 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE chapter_one (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, image_background VARCHAR(300) NOT NULL, music VARCHAR(300) NOT NULL, content LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
